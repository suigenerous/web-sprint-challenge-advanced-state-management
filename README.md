...
store - keeps state as a single source of truth throughout app
actions - actions to take using info in state
reducer - how to update state based on actions

3. What is the difference between Application state and Component state? When would be a good time to use one over the other?

component state - low level stuff that can stay in the component
application state - stuff that needs to be shared throughout

4. Describe `redux-thunk`, what does it allow us to do? How does it change our `action-creators`?

middleware that allows for async actions

5. What is your favorite state management system you've learned and this sprint? Please explain why!

redux. keeps everything central.
